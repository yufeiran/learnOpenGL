...
int main()
{
    ...
    //被光照的物体
    Shader lightingShader("../shaders/2_3_Materials_1.vs", "../shaders/2_3_Materials_1.fs");
    Shader lightCubeShader("../shaders/2_3_Materials_2_light.vs", "../shaders/2_3_Materials_2_light.fs");
    ...
    lightingShader.setVec3("material.ambient", cyanPlastic.ambient);
    lightingShader.setVec3("material.diffuse", cyanPlastic.diffuse);
    lightingShader.setVec3("material.specular", cyanPlastic.specular);
    lightingShader.setFloat("material.shininess", cyanPlastic.shininess);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::vec3 lightColor;
        static bool isNeedBrightLight = true;
        lightColor.x = sin(glfwGetTime() * 2.0f);
        lightColor.y = sin(glfwGetTime() * 0.7f);
        lightColor.z = sin(glfwGetTime() * 1.3f);
        glm::vec3 diffuseColor = lightColor * glm::vec3(0.5f);
        glm::vec3 ambientColor = diffuseColor * glm::vec3(0.2f);
        if (isNeedBrightLight == true) {

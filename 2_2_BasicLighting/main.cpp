...
int main()
{
    ...
    //被光照的物体
    Shader lightingShader("../shaders/2_2_BasicLighting_3_gouraud.vs", "../shaders/2_2_BasicLighting_3_gouraud.fs");
    Shader lightCubeShader("../shaders/2_2_BasicLighting_2.vs", "../shaders/2_2_BasicLighting_2.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightingShader.setInt("shininessValue", shininessValue);
